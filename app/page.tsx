    ...
    <main className={styles.page}>
      ...
      <section id="trial" className={`${styles.section} ${styles.cta}`}>
        <div className={styles.sectionInner}>
          ...
          <div className={styles.heroActions}><Link href="/trial" className={styles.primaryButton}>Create Your Trial Workspace</Link><Link href="/login" className={styles.secondaryButton}>Existing staff sign in</Link></div>
        </div>
      </section>
