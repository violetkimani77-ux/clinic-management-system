        ...
        <div className={styles.sectionInner}>
          <div className={styles.sectionIntro}>
            ...
            <p className={styles.sectionText}>
              Create a trial workspace for your clinic and start evaluating the core workflows, roles, security controls and reporting before making a commitment.
            </p>
            <p className={styles.sectionText}>No credit card is required for the trial.</p>
          </div>
          <div className={styles.heroActions}>
            <Link href="/trial" className={styles.primaryButton}>Create Your Trial Workspace</Link>
