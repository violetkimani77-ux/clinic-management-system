  ...
  return (
    <WorkspaceShell context={context} activeHref="/patients">
      ...
      <p style={{ color: "#6b7280" }}>
        Shared patient records for authorized clinic staff.
      </p>
        ...
        {patients.length === 0 ? (
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  <th style={{ textAlign: "left", padding: 14 }}>Patient No.</th>
                  <th style={{ textAlign: "left", padding: 14 }}>Name</th>
                  <th style={{ textAlign: "left", padding: 14 }}>Phone</th>
                  <th style={{ textAlign: "left", padding: 14 }}>Date of birth</th>
