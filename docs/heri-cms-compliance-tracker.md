...
| 5 | Audit-log patient/visit/prescription/billing *reads*, not just writes | Engineering | **Done** — PR [#31](https://github.com/violetkimani77-ux/clinic-management-system/pull/31) squash-merged as `3b17f0f`; `getVisit` (`VISIT_VIEWED`) landed with this tracker | — |
...
| `getVisit` | `VISIT_VIEWED` | this commit (was listed in the sweep, missing from #31) |
